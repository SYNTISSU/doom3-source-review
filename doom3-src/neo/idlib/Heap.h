...
##                                                                                                                                                          ##
##  Doom 3 Source Code is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the     ##
##  Free Software Foundation, either version 3 of the License, or (at your option) any later version.                                                       ##
##                                                                                                                                                          ##
##  Doom 3 Source Code is distributed in the hope that it will be useful, but WITHOUT ANY WARRANTY; without even the implied warranty of MERCHANTABILITY    ##
##  or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.                                                               ##
##                                                                                                                                                          ##
##  You should have received a copy of the GNU General Public License along with Doom 3 Source Code. If not, see <http://##w.gnu.org/licenses/>.            ##
##                                                                                                                                                          ##
##  In addition, the Doom 3 Source Code is also subject to certain additional terms. You should have received a copy of these additional terms immediately  ##
##  following the terms and conditions of the GNU General Public License which accompanied the Doom 3 Source Code.  If not, please request a copy in        ##
##  writing from id Software at the address below.                                                                                                          ##
##                                                                                                                                                          ##
##  If you have questions concerning this license or the applicable additional terms, you may contact in writing the address below.                         ##
##                                                                                                                                                          ##
##  id Software LLC                                                                                                                                         ##
##  c/o ZeniMax Media Inc. Suite 120                                                                                                                        ##
...
//  is a one byte padding that holds a kind of identifier for what size and kind the header is. These identifiers are defined as a private enumerated type
//  within idHeap. See SMALL_ALLOC, MEDIUM_ALLOC, and LARGE_ALLOC for more information on these one byte identifiers.
//
//  ~~ SMALL_HEADER_SIZE
//     The header size of a small allocation.
//
//  ~~ MEDIUM_HEADER_SIZE
//     The header size of a medium allocation. A medium header is defined as a linked list. See the idHeap private structure mediumHeapEntry_s for
//     information on the header itself.
//
//  ~~ LARGE_HEADER_SIZE
...
//  CLASS: idHeap
//
//  Internal data structure, _____. idHeap used to be in the idLib/Heap.cpp body file, moved for organizational purposes.
//
//  ~~ Constructor
//     It calls 'Init', so it does with 'Init' does.
//
//  ~~ Destructor
...
//     Small heap allocator lists (for allocs of 1-255 bytes).
//
//  ~~ dword smallCurPageOffset
//     Byte offset in current page.
//
//  ~~ page_s* smallCurPage
//     Current page for small allocations.
//
//  ~~ page_s* smallFirstUsedPage
//     First used page of the small heap manager.
//
//  ~~ page_s* mediumFirstFreePage
//     First partially free page.
//
//  ~~ page_s* mediumLastFreePage
//     Last partially free page.
//
//  ~~ page_s* mediumFirstUsedPage
//     Completely used page.
//
//  ~~ page_s* largeFirstUsedPage
//     First page used by the large heap manager.
//
//  ~~ page_s* swapPage
//     Stuff stuff stuff. Stuff stuff.
//
...
//
//  ~~ dword pageSize
//     Size of one alloc page in bytes.
//
//  ~~ dword pageRequests
//     Page requests.
//
//  ~~ dword OSAllocs
//     Number of allocs made to the OS.
//
//  ~~ int c_heapAllocRunningCount
//     Stuff stuff stuff. Stuff stuff.
//
//  ~~ void *defragBlock
//     A single huge block that can be allocated at startup, then freed when needed.
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
